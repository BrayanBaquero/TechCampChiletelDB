--ROLES --
insert into roles(id_role,nombre) values(ROLES_SEQ.NEXTVAL,'ROLE_ADMIN');
insert into roles(id_role,nombre) values(ROLES_SEQ.NEXTVAL,'ROLE_USER');
...
--USUARIO 2--
INSERT INTO USUARIOS(ID_USUARIO,EMAIL,NOMBRE,NOMBRE_USUARIO,PASSWORD) VALUES (USUARIOS_SEQ.NEXTVAL,'u@u.u','UserTest','UserTest','$2a$10$zGt1j8FNe8LR.VDVE1s0K.VDfuw3Yu.BVHuCEBYSbxMRDaAe6dhAy');
