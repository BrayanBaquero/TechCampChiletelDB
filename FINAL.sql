...
--------------------------------------------------------------------------------------
----------JOIN DE INCIDENCIAS Y ORDENES DE ATENCION--------------------------------
...
SELECT CL.ID_CLIENTE CLIENTE,TI.PRIORIDAD P_TDAÑO,TC.PRIORIDAD P_TCLIENTE,CL.ID_ZONA,I.FECHA_REGISTRO,ORT.ID_ORDEN_ATENCION FROM ORDENES_ATENCION ORT 
...
---------ENCONTRAR A TECNICOS- POR PRIORIDA Y ZONA DE ATENCION----------------------------------------------
